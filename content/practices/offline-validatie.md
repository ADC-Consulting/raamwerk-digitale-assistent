...
summary: >
  Offline validatie betekent testen met een vaste set testvragen voordat echte
...
Onderscheid offline en online validatie helder: offline = testen met een vaste set vragen voordat de assistent in productie is. Online = meten terwijl echte gebruikers de assistent gebruiken. Beide horen erbij, maar in andere fasen en met andere doelen.
