...
Formuleer een AI-strategie die richting geeft: bepaal de rol van AI in de organisatie (visie en ambitie) en de waardedomeinen waarin AI concreet waarde creëert. Benoem ook de randvoorwaarden die daarvoor nodig zijn: data, technologie, mensen, governance en processen.
...
Definieer waardedomeinen in plaats van geïsoleerde use cases: een waardedomein bestaat uit meerdere geïntegreerde use cases die samen als vliegwiel werken (bijvoorbeeld een algemene digitale assistent gecombineerd met taakspecifieke AI-agents). Zo'n domein levert meer op dan een verzameling losse experimenten.
