...
summary: >
  In een multi-agent opzet kunnen agents worden gespiegeld aan bestaande
  governance functies en verantwoordelijkheden in de organisatie. Zo blijft helder
  wie waarvoor verantwoordelijk is en helpen agents bij het afdwingen of
  automatiseren van governance.
domains: [governance]
