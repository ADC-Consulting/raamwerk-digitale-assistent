...
summary: >
  ...
  actief bij te houden over meerdere gesprekken met dezelfde persoon heen. Onderwerp, identifiers, rol en
...
Beheer de gesprekscontext actief: zorg dat per gesprekgegevens als onderwerp, zaak- of aanvraagnummer en rol van de gebruiker worden vastgelegd en bijgewerkt. Bij assistenten zonder login gaat het om context op sessieniveau.

Beperk de context die richting het model gaat: sla alle berichten technisch op, maar stuur naar het LLM alleen de laatste paar berichten plus een compacte samenvatting van het gespreksgeheugen. te veel verhoogt latency en kosten zonder dat het de antwoordkwaliteit verbetert namelijk.

Definieer resetregels voor het geheugen: bepaal in je AVG- en bewaartermijnenbeleid hoe lang het gespreksgeheugen maximaal nodig is voor het doel van de dienstverlening, en zorg dat het daarna automatisch wordt verwijderd of geanonimiseerd. Bijvoorbeeld na afronding van een taak.

Bevestig kritieke stappen: laat de assistent bij onomkeerbare acties eerst expliciet samenvatten wat er gaat gebeuren ("Ik ga zaak 1234 sluiten, klopt dat?").
