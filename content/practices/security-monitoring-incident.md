...
Borg meldplicht-workflows in lijn met de Cyberbeveiligingswet (NIS2-implementatie): meldplicht na incident bij significant effect, geïntegreerd met bestaande CSIRT-processen. Wie meldt, binnen hoeveel tijd, aan welk CSIRT: vooraf vastleggen.

Volg externe threat intel: ENISA Threat Landscape (jaarlijks dreigingsoverzicht inclusief AI-specifieke patronen) en NCSC-publicaties signaleren wat aanvallers in het echt doen.
...
Plan rond model-updates: wat doe je als een leverancier een nieuwe versie uitrolt? Test elke nieuwe modelversie in een staging-omgeving voordat je hem in productie laat.
